...
The results of this analysis are released in two main files:

- Summary statistics MatrixTable: `gs://ukb-diverse-pops/combined_results/results_full.mt` (12.75 T)
- Meta-analysis MatrixTable: `gs://ukb-diverse-pops/combined_results/meta_analysis.mt` (12.52 T)

We also provide the following derived datasets for convenience:

- Lambda GC per phenotype Table: `gs://ukb-diverse-pops-public/sumstats_qc_analysis/lambda/lambdas_full.ht` (880 K)

These files can be accessed by cloning this and the https://github.com/Nealelab/ukb_common repo and accessing them programmatically:
...
+--------------+-----------+--------------+--------+----------+--------------------+
+-----------------------+----------------+-------------------------+
| pheno_data.n_controls | pheno_data.pop | pheno_data.heritability |
+-----------------------+----------------+-------------------------+
|                 int32 | str            |                 float64 |
+-----------------------+----------------+-------------------------+
|                    NA | "AFR"          |                2.54e-01 |
...
+-----------------------+----------------+-------------------------+
+---------------------------+--------------------------+----------------------+
| pheno_data.inv_normalized | pheno_data.saige_version | pheno_data.lambda_gc |
+---------------------------+--------------------------+----------------------+
|                      bool | str                      |              float64 |
+---------------------------+--------------------------+----------------------+
|                     false | "SAIGE_0.36.4"           |             1.03e+00 |
|                     false | "SAIGE_0.36.4"           |             1.04e+00 |
|                     false | "SAIGE_0.36.4"           |             9.98e-01 |
|                     false | "SAIGE_0.36.4"           |             9.95e-01 |
|                     false | "SAIGE_0.36.4"           |             1.41e+00 |
|                     false | "SAIGE_0.36.4"           |             9.99e-01 |
|                     false | "SAIGE_0.36.4"           |             1.02e+00 |
|                     false | "SAIGE_0.36.4"           |             1.02e+00 |
|                     false | "SAIGE_0.36.4"           |             1.02e+00 |
|                     false | "SAIGE_0.36.4"           |             9.59e-01 |
+---------------------------+--------------------------+----------------------+
+-----------------------+---------------------------+------------------------+
