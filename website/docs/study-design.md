...
:::note
Different ancestry groups are separately analyzed for statistical reasons; this does not imply that there are biological differences between ancestry groups (see [“Do these results imply that genetics are responsible for the phenotypic differences between ancestry groups?”](study-design#do-these-results-imply-that-genetics-are-responsible-for-the-phenotypic-differences-between-ancestry-groups)).
:::note
